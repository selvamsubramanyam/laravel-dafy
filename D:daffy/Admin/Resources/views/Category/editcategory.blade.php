                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/category/updatecategory')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="name" placeholder="Category Name" value="{{$category->name}}" required="required">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            <img src="{{URL('storage/app/'.$category->image)}}" width="60" height="60">
                                    ...
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-form-label">Parent Info:</label>
                                            <div class="col-xs-12 col-lg-8">
                                                <input type="text" value="{{$category->parent_name}}" name="parent_name" id="parent_name" value="" placeholder="--Parent name--"  readonly>
                                            </div>
                                    </div>
                                    ...
                                    <!-- <div id="fieldset_spec" class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-form-label">Please specify about child category:</label>
                                        <div class="col-xs-12 col-lg-8">
                                            <input type="checkbox" <?php if($category->is_last_child == 1) {?>checked readonly> <?php } ?>
                                            <label for="last_child">Last Child Category? </label>
                                            <input type="checkbox"> <?php if($category->is_last_child == 0) {?>checked readonly> <?php } ?>
                                    ...
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Position:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="order" placeholder="Category Position" value="{{$category->order}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="viewport">
                                        <ul class="cat">
                                            ...
                                            <!-- @foreach($category as $cat) -->
                                                <li>
                                                    <a href="#" id="{{ $category->id }}" class="icon-list-main icon-list block rel lheight16 tdnone clr">
                                                        <span class="inlblk">{{ $category->name }}</span>
