                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/events/addevents')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="title" placeholder="Events Name" required="required">
                                    ...
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            <input type="text"  class="form-control form-border"  name="videourl" placeholder="Video URL" required="required">
                                        </div>
                                    </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                     <input type="date" class="form-control form-border" placeholder="Valid From" name="validfrom" required="required">
                                      ...
                                      <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                     <input type="datetime-local" class="form-control form-border" placeholder="Valid From" name="validto" required="required">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            <input type="datetime-local" class="form-control form-border" placeholder="Interactive date" name="interactive">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                    <textarea class="form-control form-border" placeholder="Description" name="description" required></textarea>
                                        </div>
                                    </div>
                                </div>
