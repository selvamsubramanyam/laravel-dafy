                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/category/attribute/store')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="field_name" placeholder="Attribute Name" required="required">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group"  id="values">
                                        ...
                                        <input type="text" name="values" id="values" placeholder="Add Possible Values *" class="form-control bootstrap-tagsinput" value="" data-role="tagsinput" required>
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <input type="checkbox" class="custom-control-input" name="is_filter" id="defaultChecked2" value="1">
                                    </div>
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="is_detail_filter" id="defaultChecked2" value="1">
                                    </div>
