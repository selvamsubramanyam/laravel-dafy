...
<div class="m-alert m-alert--outline alert alert-success alert-dismissible fade" role="alert" style="    color: #1bbf23; background-color: #fff">
                           ...
                           Seller Deleted Succeefully
                        </div>
                    <div class="text-right mb-2">
                       <a href="{{route('user.export','seller')}}" class="btn  btn-success btn-sm add-prod-btn br-0">
                            <i class="fa fa-download"></i> Export
                        </a>
                        <a href="{{URL('admin/seller/add')}}" class="btn  btn-primary-blue btn-sm add-prod-btn br-0">
                            <i class="fa fa-plus"></i> Add New
                        </a>
                    </div>

                    <div class="table-responsive table-responsive1">
                        <table class="table table-striped table-bordered jambo_table bulk_action m-datatable__table"  id="seller_list_datatable">
                            ...
                            <thead class="m-datatable__head">
                                ...
                                <th data-field="Business_name" class="m-datatable__cell m-datatable__cell--sort column-title">
                                   <center>Business Name</center> 
                                </th>
                                <th data-field="E-mail" class="m-datatable__cell m-datatable__cell--sort column-title">
                                   <center>E-mail</center> 
                                </th>
                                <th data-field="Business_e-mail" class="m-datatable__cell m-datatable__cell--sort column-title">
                                   <center>Business E-mail</center> 
                                </th>
                                ...
                                <th data-field="Business_image" class="m-datatable__cell m-datatable__cell--sort column-title">
                                     <center>Business Image</center>
                                </th>

                                <th data-field="City" class="m-datatable__cell m-datatable__cell--sort column-title">
                                     <center>City</center>
                                </th>

                                <th data-field="State" class="m-datatable__cell m-datatable__cell--sort column-title"> 
                                    <center>State</center>
                                </th>
