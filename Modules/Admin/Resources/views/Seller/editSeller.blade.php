                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/seller/update')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter name"  value="{{ $user->name ?? old('name') }}" required="required">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Business Name*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('business_name') is-invalid @enderror" id="business_name" name="business_name" placeholder="Enter business name"  value="{{$user->business_name ?? old('business_name') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            E-mail*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="email" class="form-control form-border  @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter email"  value="{{ $user->email ?? old('email') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="email" class="form-control form-border  @error('business_email') is-invalid @enderror" id="business_email" name="business_email" placeholder="Enter business email"  value="{{ $user->business_email ?? old('business_email') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="form-group row form-space ">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        ...
                                        <img id="thump" src="{{asset('storage/app/'.$user->image)}}" alt="your image" height="75px" width="75px"/>
                                        <div class="invalid-feedback active">
                                ...
                                <div class="form-group row form-space ">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        ...
                                        <img id="business_img" src="{{asset('storage/app/'.$user->business_image)}}" alt="your image" height="75px" width="75px"/>
                                        <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Mobile Number*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="tel" class="form-control form-border  @error('mobile') is-invalid @enderror" id="mobile" name="mobile" placeholder="Enter mobile number"  value="{{ $user->mobile ?? old('mobile') }}" pattern="[0-9]{10}" required="required">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Wallet Money:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('wallet') is-invalid @enderror" id="wallet" name="wallet" placeholder="Enter wallet money"  value="{{ $user->wallet ?? old('wallet')  }}">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Latitude*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('latitude') is-invalid @enderror" id="lat" name="latitude" placeholder="Enter latitude"  value="{{ $user-> latitude ?? old('latitude') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Longitude*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('longitude') is-invalid @enderror" id="lng" name="longitude" placeholder="Enter longitude"  value="{{ $user->longitude ??  old('longitude') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Street*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('street') is-invalid @enderror" id="street" name="street" placeholder="Enter street"  value="{{ $userAddress->street ?? old('street') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Area*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('area') is-invalid @enderror" id="area" name="area" placeholder="Enter area"  value="{{ $userAddress->area ?? old('area') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            City*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('city') is-invalid @enderror" id="city" name="city" placeholder="Enter city"  value="{{ $userAddress->city ?? old('city') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Pincode*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="number" class="form-control form-border  @error('pincode') is-invalid @enderror" id="pincode" name="pincode" placeholder="Enter pincode"  value="{{ $userAddress->pincode ??  old('pincode') }}" required="required">
                                            <div class="invalid-feedback active">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            <select  class="form-control @error('state_id') is-invalid @enderror" id="state_id" name="state_id" style="width: 100%;" required>
                                                ...
                                                @forelse($states as $state)
                                                    <option value="{{$state->id}}" {{($state->id == optional($userAddress)->state_id) ? 'selected="selected"': ''}}>{{$state->name}}</option>
                                                @empty
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        <div class="statusBox">
                                            <input type="radio" id="status-1" name="status" value="1" {{ ($user->is_active=="1")? "checked" : "" }}><span>Active</span> 
                                            <input type="radio" id="status-2" name="status" value="0" {{ ($user->is_active=="0")? "checked" : "" }}><span>Inactive</span> 
                                        </div>          
                                    </div>
                                </div>
