            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="clearfix"></div>
                            ...
                            <div class="container"> 
                                ...
                                <form class="d-flex" id="adminCommissionreportForm">
                                {{csrf_field()}}
                                    <div class="row">
                ...
                <div class="x_content">
                    <div class="m-alert m-alert--outline alert alert-success alert-dismissible fade" role="alert" style="color: #1bbf23; background-color: #fff">
                        ...
                        <div class="text-right">
                        <form method="post" action="{{URL('/admin/vendor_commission/export')}}" >
                                {{csrf_field()}}
                                @if(Auth::guard('admin')->check())
                    ...
                    <div class="table-responsive table-responsive1">
                        <table class="table table-striped table-bordered jambo_table bulk_action m-datatable__table"  id="commission_report_list_datatable">
...
$('body').on('click','.status',function(e) {
    ...
    if( data_id !='') { 
        ...
        $.ajax({ 
            url: base_url+'/admin/change_commission_status',
            type: 'post',
            dataType: 'json',
            ...
            success: function(data){
                ...
                if($.isEmptyObject(data.error)){
                    // alert(data.success);
                    $('#commission_report_list_datatable').DataTable().ajax.reload(null,false);
                    // location.reload();
                }else {
                    alert(data.error);
                }
