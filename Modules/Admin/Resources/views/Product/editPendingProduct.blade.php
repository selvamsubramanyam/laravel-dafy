                        ...
                        <div class="col-md-6 col-xs-12">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Sku*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border @error('sku') is-invalid @enderror" name="sku" id="sku" placeholder="Enter product sku"  value="{{ $product->sku ?? old('sku') }}" required="required">
                                            <div class="invalid-feedback active">
                          ...
                          <!-- <div class="">
                                ...
                                <div class="text-right">
                                    ...
                                    <button type="Submit" class="btn btn-info btn-sm" id="myButtonID">Approve</button>
                                </div>
