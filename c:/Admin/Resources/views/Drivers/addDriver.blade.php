                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/driver/store')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="tel" class="form-control form-border  @error('mobile') is-invalid @enderror" id="mobile" name="alt_mobile" placeholder="Enter alternate mobile number"  value="{{ old('alt_mobile') }}" pattern="[0-9]{10}" required="required">
                                            <small>Format: 10 digit valid mobile number</small>
                                            <div class="invalid-feedback active">
                                 ...
                                 <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Building Name*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('build_name') is-invalid @enderror" id="build_name" name="build_name" placeholder="Enter Build Name"  value="{{ old('build_name') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Latitude*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('latitude') is-invalid @enderror" id="latitude" name="latitude" placeholder="Enter Latitude"  value="{{ old('latitude') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Longitude*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border  @error('longitude') is-invalid @enderror" id="longitude" name="longitude" placeholder="Enter Longitude"  value="{{ old('longitude') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Address:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <textarea class="form-control form-border  @error('address') is-invalid @enderror" id="address" name="address" rows="3">{{ old('city') }}</textarea>
                                            <div class="invalid-feedback active">
