                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/shop/service/store')}}"  enctype='multipart/form-data'>
                                ...
                                <!-- <div class="">
                                    <div class="form-group"  id="">
                                        ...
                                        <span style="color: red">&nbsp;&nbsp;[Press <i>ENTER</i>  Key after adding each value]</span>
                                        <br>
                                        <span id="features_values" class="label label-primary" <?php if($services == null) { ?> style="display: none;" <?php } else { ?>>
                                        {{$services->service_names}} <?php } ?>
                                        </span>
