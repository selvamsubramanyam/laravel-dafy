                    ...
                    <div class="row">
                            ...
                            <form method="post" action="{{URL('admin/offer/update')}}"  enctype='multipart/form-data'>
                                    ...
                                    <div id="shops" class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            ...
                                            @foreach($shops as $shop)
                                                    <option value="{{$shop->id}}" {{($shop->id == $offer->seller_id) ? 'selected="selected"': ''}}>{{$shop->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                           ...
                                           @forelse($products as $product) 
                                                 @if(in_array($product->id, $productIds))
                                                    <option value="{{$product->id}}" {{in_array($product->id, old('products') ?: []) ? "selected": ""}} selected="true">{{$product->name}}</option>
                                                 @else
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Title*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="title" placeholder="Offer title" value="{{$offer->title ?? old('title')}}" required="required">
                                            <div class="invalid-feedback active">
                                                <i class="fa fa-exclamation-circle fa-fw"></i> @error('title') <span class="er">{{ $message }}</span> @enderror
                                            </div>
                                        </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                    <textarea class="form-control form-border" placeholder="Offer Description" name="description">{{nl2br($offer->description ?? old('description'))}}</textarea>
                                        </div>
                                    </div>  
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                    <textarea class="form-control form-border" placeholder="About Offer" name="about">{{nl2br($offer->about ?? old('about'))}}</textarea>
                                        </div>
                                    </div>  
                                </div>

                                <div class="form-group row form-space ">
                                    <label class="col-xs-12 col-lg-4 col-form-label">Offer Image*:</label>
                                    <div class="col-xs-12 col-lg-8">
                                        <input type='file' id="imgInp" accept="image/*" class="form-control form-border @error('pic') is-invalid @enderror" name="pic"/>
                                        <img id="thump" src="{{asset('storage/app/'.$offer->image)}}" alt="your image" height="75px" width="75px"/>
                                        <div class="invalid-feedback active">
                                            <i class="fa fa-exclamation-circle fa-fw"></i> @error('pic') <span class="er">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        <div class="statusBox">
                                            <input type="radio" id="discount_type-1" name="discount_type" value="1" {{($offer->discount_type) ==1 ? 'checked' : '' }} required><span>Percentage</span> 
                                            <input type="radio" id="discount_type-2" name="discount_type" value="2" {{($offer->discount_type) ==2 ? 'checked' : '' }} required><span>Flat</span> 
                                        </div>          
                                    </div>
                                </div>
                                ...
                                <div class="sho d-none">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border @error('discount_value') is-invalid @enderror" name="discount_value" id="discount_value" placeholder="Discount value"  value="{{ $offer->discount_value ?? old('discount_value') }}" required="required">
                                            <div class="invalid-feedback active">
                                ...
                                <div class="max" style="display:none">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" id="max_disc" name="max_discount_value" placeholder="Maximum discount value" value="{{ $offer->max_discount_value ?? old('max_discount_value') }}">
                                        </div>
                                    </div>
                                </div>
                       ...
                       {{--        <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="min_amount_price" placeholder="min amount price" value="{{ $offer->min_amount_price ?? old('min_amount_price') }}">
                                        </div>
                                    </div>
                                </div>--}}
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                     <input type="datetime-local" class="form-control form-border" placeholder="Valid From" name="validfrom" value="{{Carbon\Carbon::parse($offer->valid_from)->format('Y-m-d\TH:i') ?? old('validfrom' , date('Y-m-d'))}}" required="required">
                                      ...
                                      <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                     <input type="datetime-local" class="form-control form-border" placeholder="Valid From" name="validto" value="{{Carbon\Carbon::parse($offer->valid_to)->format('Y-m-d\TH:i') ?? old('validto' , date('Y-m-d'))}}" required="required">
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        <div class="statusBox">
                                            <input type="radio" id="status-1" name="status" value="1" {{($offer->status) ==1 ? 'checked' : '' }}><span>Active</span> 
                                            <input type="radio" id="status-2" name="status" value="0" {{($offer->status) ==0 ? 'checked' : '' }}><span>Inactive</span> 
                                        </div>          
                                    </div>
                                </div>
