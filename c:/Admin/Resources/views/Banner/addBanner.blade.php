                            ...
                            <form method="post" action="{{URL('admin/banner/store')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Title*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="title" placeholder="Banner Title" required="required">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                    <textarea class="form-control form-border" placeholder="Banner Description" name="description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row form-space">
                                     ...
                                     <input type="date" class="form-control form-border" placeholder="Valid From" name="validfrom" required="required">
                                      ...
                                      <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                     <input type="date" class="form-control form-border" placeholder="Valid From" name="validto" required="required">
