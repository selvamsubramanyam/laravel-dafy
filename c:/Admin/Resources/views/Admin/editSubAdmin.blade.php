                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/additonaluser/update')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        <label class="col-xs-12 col-lg-4 col-sm-5 col-xs-12 col-form-label">
                                            Password*:</label>
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="password" class="form-control form-border" name="password" placeholder="Password" value="{{old('password')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="password" class="form-control form-border" name="password_confirmation" value="{{old('password_confirmation')}}" placeholder="Confirm Password" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        <div class="statusBox">
                                            <input type="radio" id="status-1" name="status" value="1" {{$user->status==1 ? 'checked' : ''}}><span>Active</span> 
                                            <input type="radio" id="status-2" name="status" value="0" {{$user->status==0 ? 'checked' : ''}}><span>Inactive</span> 
                                        </div>          
                                    </div>
                                </div>
