                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <!--begin::Form-->
                            <form method="post" action="{{URL('admin/unit/update')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="name" placeholder="Unit Name" value="{{$unit->name}}" required="required">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row form-space">
                                    <label class="col-xs-12 col-lg-4 col-form-label">Status:</label>
                                        ...
                                        <div class="statusBox">
                                            ...
                                            <?php if($unit->is_active == 1) { ?>checked="checked"> <?php } ?>
                                            <span>Active</span> <span></span>
                                            <input type="radio" id="status-2" name="status" value="0" <?php if($unit->is_active == 0) { ?>checked="checked"> <?php } ?><span>Inactive</span> 
                                        </div>          
                                        </div>
                                </div>
