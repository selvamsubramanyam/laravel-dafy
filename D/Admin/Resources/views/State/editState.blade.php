                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="name" placeholder="State Name" value="{{$state->name}}" required="required">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row form-space">
                                    ...
                                    <div class="col-xs-12 col-lg-8">
                                        <div class="statusBox">
                                            ...
                                            <?php if($state->is_active == 1) { ?>checked="checked"> <?php } ?>
                                            <span>Active</span> <span></span>
                                            <input type="radio" id="status-2" name="status" value="0" <?php if($state->is_active == 0) { ?>checked="checked"> <?php } ?><span>Inactive</span> 
                                        </div>          
                                    </div>
                                </div>
