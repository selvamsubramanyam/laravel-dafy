            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="clearfix"></div>
                            ...
                            <div class="container"> 
                                ...
                                <form class="d-flex" id="commissionReport">
                                {{csrf_field()}}
                                    <div class="row">
                                      
                                        <div class="col-md-4">
                                            <label class="col-xs-12 col-lg-4 col-form-label"> From:</label>
                                            <div class=" col-lg-8">
                                            <input type="date" class="form-control form-border"  id="orderfrom" placeholder="Order From" name="orderfrom" value="" >
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="col-xs-12 col-lg-4 col-form-label"> To:</label>
                                            <div class="col-lg-8">
                ...
                <div class="x_content">
                    <div class="m-alert m-alert--outline alert alert-success alert-dismissible fade" role="alert" style="color: #1bbf23; background-color: #fff">
                        ...
                        <div class="text-right">
                        <form method="post" action="{{URL('/seller/vendor_commission/export')}}" >
                                {{csrf_field()}}
                                <input type="hidden"  class="saleshop" name="shop_id" value ="{{$shop_id}}" id="shop_val">
                    ...
                    <div class="table-responsive table-responsive1">
                        <table class="table table-striped table-bordered jambo_table bulk_action m-datatable__table"  id="vendor_commission_report_datatable">
...
$('body').on('click','.status',function(e) {
    ...
    if( data_id !='') { 
        ...
        $.ajax({ 
            url: base_url+'/seller/change_commission_status',
            type: 'post',
            dataType: 'json',
            ...
            success: function(data){
                ...
                if($.isEmptyObject(data.error)){
                    // alert(data.success);
                    $('#vendor_commission_report_datatable').DataTable().ajax.reload(null,false);
                    // location.reload();
                }else {
                    alert(data.error);
                }
