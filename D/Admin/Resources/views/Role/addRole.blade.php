                            ...
                            <form method="post" action="{{URL('admin/role/store')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8 ">
                                            <input type="text" class="form-control form-border" name="name" placeholder="Role Name" required="required">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="form-group row form-space">
                                        ...
                                        <div class="col-xs-12 col-lg-8">
                                            <textarea class="form-control form-border"  rows="3" name="description" id="description" required>{{nl2br(old('description'))}}</textarea>
                                        </div>
                                    </div>  
                                </div>
